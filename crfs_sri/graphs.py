    ...
    def get_clique_set(self, len_observation, clique_set_index):
        ...
        if clique_set_index == 0: # singleton cliques
            ...
            for t in range(2, len_observation):
                ...
                clique_set.append(Clique('double', ((0, t-2), (0, t)), clique_set_index))                               
...
class TwoLevelXGrid(object):
    
    def __init__(self):

        self.id = 'two-level-X-grid'
    ...
    def get_clique_set_index_set(self, size):
        ...
        if size == 'single':
            ...
            clique_set_index_set = [2, 3, 4, 5, 6]
        elif size == 'all':
            clique_set_index_set = [0, 1, 2, 3, 4, 5, 6]
    ...
    def get_sub_clique_set_index_set(self, clique_set_index):
        ...
        elif clique_set_index == 5:            

            sub_clique_set_index_set = (0, 0)

        elif clique_set_index == 6:
    ...
    def get_clique_set(self, len_observation, clique_set_index):
        ...
        if clique_set_index == 0: # singleton cliques
            ...
            for t in range(1, len_observation):
                ...
                clique_set.append(Clique('double', ((0, t), (1, t-1)), clique_set_index))

        elif clique_set_index == 4: # doubleton cliques

            for t in range(len_observation-1):

                clique_set.append(Clique('double', ((0, t), (1, t+1)), clique_set_index))

        elif clique_set_index == 5: # doubleton cliques

            for t in range(1, len_observation):

                clique_set.append(Clique('double', ((0, t-1), (0, t)), clique_set_index))

        elif clique_set_index == 6: # doubleton cliques
