...
parser.add_option("--trainfile", "--t", default = None)
parser.add_option("--traindevelfile", "--td", default = None)

(options, args) = parser.parse_args()

#  Opening the html file and loading into Beautiful Soup

page=open(os.getcwd()+'/'+options.infile+'.html')
train=open(os.getcwd()+'/'+options.infile+'.train','w')
devel=open(os.getcwd()+'/'+options.infile+'.train.devel','w')
...
print '\ttrain file\t\t:', options.infile+'.train'
print '\ttrain.devel file\t:', options.infile+'.train.devel'
